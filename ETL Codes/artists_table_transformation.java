...
package project.etl_artists_0_1;
 ...
 * @status
 */
public class etl_artists implements TalendJob {
	...
	private final String jobName = "etl_artists";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(etl_artists.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:rvmj1nt/Y5qZyywGiBQu7BzEXR/r8hCwbVW8D3WsqQIXTw==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:u3zKGESXHpr/ebo1V2k1g4E3MDFsL0zbQT4x/P0B7B+ulg==");
	...
	public static class foundStruct implements routines.system.IPersistableRow<foundStruct> {
		final static byte[] commonByteArrayLock_PROJECT_IE7374_etl_artists = new byte[0];
		static byte[] commonByteArray_PROJECT_IE7374_etl_artists = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.artists_id == null) ? 0 : this.artists_id.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.artists_id == null) {
				if (other.artists_id != null)
					return false;

			} else if (!this.artists_id.equals(other.artists_id))
		...
		public void copyDataTo(foundStruct other) {
			...
			other.artists_id = this.artists_id;
			other.artists_name = this.artists_name;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJECT_IE7374_etl_artists.length) {
					if (length < 1024 && commonByteArray_PROJECT_IE7374_etl_artists.length == 0) {
						commonByteArray_PROJECT_IE7374_etl_artists = new byte[1024];
					} else {
						commonByteArray_PROJECT_IE7374_etl_artists = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJECT_IE7374_etl_artists, 0, length);
				strReturn = new String(commonByteArray_PROJECT_IE7374_etl_artists, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJECT_IE7374_etl_artists, 0, length);
				strReturn = new String(commonByteArray_PROJECT_IE7374_etl_artists, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECT_IE7374_etl_artists) {

				try {

					int length = 0;

					this.artists_id = readString(dis);

					this.artists_name = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.artists_id, dos);

				// String

				writeString(this.artists_name, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("artists_id=" + artists_id);
			sb.append(",artists_name=" + artists_name);
		...
		public int compareTo(foundStruct other) {
			...
			returnValue = checkNullsAndCompare(this.artists_id, other.artists_id);
			if (returnValue != 0) {
				return returnValue;
			}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("artists");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("artists");
				}
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"artists_name\" = ?,\"popularity\" = ?,\"followers\" = ? WHERE \"artists_id\" = ?";
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = ("artists");
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("artists");
				}
				...
				String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2
						+ "\" (\"artists_id\",\"artists_name\",\"popularity\",\"followers\") VALUES (?,?,?,?)";
...
// ###############################
				...
				String dbquery_tDBInput_1 = "SELECT \n  \"spotify_data\".\"artists\".\"name\", \n  \"spotify_data\".\"artists\".\"id\", \n  \"spotify_data\".\"artists"
						+ "\".\"popularity\", \n  \"spotify_data\".\"artists\".\"followers\"\nFROM \"spotify_data\".\"artists\"";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row1.popularity = rs_tDBInput_1.getInt(3);
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							row1.followers = rs_tDBInput_1.getInt(4);
							if (rs_tDBInput_1.wasNull()) {
								row1.followers = null;
							}
						}
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row2HashKey.artists_id = row1.id;
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.artists_id = '" +
							// row2HashKey.artists_id + "'");
						} // G 071
...
// # Output table : 'found'
								found_tmp.artists_id = row2.artists_id;
								found_tmp.artists_name = row1.name;
								found_tmp.popularity = row1.popularity;
								found_tmp.followers = row1.followers;
								found = found_tmp;
...
// # Filter conditions 
							if (rejectedInnerJoin_tMap_1) {
								not_found_tmp.artists_id = row1.id;
								not_found_tmp.artists_name = row1.name;
								not_found_tmp.popularity = row1.popularity;
								not_found_tmp.followers = row1.followers;
...
// Start of branch "found"
						if (found != null) {
							...
							if (found.artists_name == null) {
								pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(1, found.artists_name);
							}

							if (found.popularity == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(2, found.popularity);
							}

							if (found.followers == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setLong(3, found.followers);
							}

							if (found.artists_id == null) {
								pstmt_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4 + count_tDBOutput_1, found.artists_id);
							}
...
// Start of branch "not_found"
						if (not_found != null) {
							...
							if (not_found.artists_id == null) {
								pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(1, not_found.artists_id);
							}

							if (not_found.artists_name == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, not_found.artists_name);
							}

							if (not_found.popularity == null) {
								pstmt_tDBOutput_2.setNull(3, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(3, not_found.popularity);
							}

							if (not_found.followers == null) {
								pstmt_tDBOutput_2.setNull(4, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setLong(4, not_found.followers);
							}
...
// ###############################      
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.artists_name = readString(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.artists_name = readString(dis, objectIn);
				...
				if (length == -1) {
					...
					this.followers = objectIn.readLong();
				}
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.artists_name, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeString(this.artists_name, dos, objectOut);
				...
				if (this.followers == null) {
					...
					objectOut.writeLong(this.followers);
				}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_2 = "SELECT \n  \"spotify_dw\".\"artists\".\"artists_id\", \n  \"spotify_dw\".\"artists\".\"artists_name\", \n  \"spotify_dw\"."
						+ "\"artists\".\"popularity\", \n  \"spotify_dw\".\"artists\".\"followers\"\nFROM \"spotify_dw\".\"artists\"";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							row2.artists_id = null;
						} else {

							row2.artists_id = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
						}
						if (colQtyInRs_tDBInput_2 < 2) {
							row2.artists_name = null;
						} else {

							row2.artists_name = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
						}
						if (colQtyInRs_tDBInput_2 < 3) {
							row2.popularity = null;
						} else {

							row2.popularity = rs_tDBInput_2.getInt(3);
						...
						if (colQtyInRs_tDBInput_2 < 4) {
							...
							row2.followers = rs_tDBInput_2.getLong(4);
							if (rs_tDBInput_2.wasNull()) {
								row2.followers = null;
							}
						}
						...
						row2_HashRow.artists_id = row2.artists_id;

						row2_HashRow.artists_name = row2.artists_name;

						row2_HashRow.popularity = row2.popularity;

						row2_HashRow.followers = row2.followers;
	...
	public static void main(String[] args) {
		final etl_artists etl_artistsClass = new etl_artists();

		int exitCode = etl_artistsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = etl_artists.class.getClassLoader()
					.getResourceAsStream("project_ie7374/etl_artists_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = etl_artists.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : etl_artists");
		}
...
/************************************************************************************************
 * 117650 characters generated by Talend Open Studio for Data Integration on the
 * May 16, 2024, 12:59:29 PM EDT
 ************************************************************************************************/
